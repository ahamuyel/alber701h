      ...
      <div className="container mx-auto px-4 mb-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          ...
          <div className="md:w-1/2 text-center">
            ...
            <Link
              href="https://drive.google.com/file/d/1zpn44be4zR-EPPLsfNnkknL6r8bRa7UE/view?usp=sharing"
              target="_blank"
          ...
          <div className="md:w-1/2 text-gray-700">
            <ul className="list-none space-y-4">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 mr-2 flex-shrink-0">
                ...
                <p>
                  Formação intensiva na <span>42 Luanda</span> com foco em <span>Shell, C, C++</span>, POO, algoritmos e boas práticas de engenharia de software.
                </p>
              </li>
              <li className="flex items-start">
                ...
                <p>
                  Desenvolvimento de aplicações web modernas com <span>React, Next.js e Tailwind CSS</span>.
                </p>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 mr-2 flex-shrink-0">
                ...
                <p>
                  ...
                  (CIDR,
                  sub-redes, roteamento) e <span>administração de sistemas</span>
                  com <span>Docker</span> e ambiente Linux.
                </p>
              </li>
            </ul>
          </div>
